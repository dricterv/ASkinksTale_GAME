...
public class EnemyMovementChemical : MonoBehaviour
{
    ...
    private EnemyCombatChemical enemyCombat;
    ...
    void Start()
    {
        enemyCombat = GetComponent<EnemyCombatChemical>();
        rb = GetComponent<Rigidbody2D>();
        anim = GetComponent<Animator>();
        anim.SetFloat("xFace", facing.x);
    ...
    public void Patrol(Vector2 direction)
    {
        ...
        else if ((Mathf.Abs(hori) > Mathf.Abs(vert)) && isDirectional == true)
        {
            ...
            anim.SetFloat("xFace", facing.x);
            anim.SetFloat("yFace", facing.y);
            anim.SetFloat("xMove", facing.x);
            anim.SetFloat("yMove", facing.y);
